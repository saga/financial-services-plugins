...
- **信用与固定收益**：债券、久期、凸性、OAS、利差 → [信用与固定收益.md](../../../../金融知识学习/信用与固定收益.md)
- **期权与波动率**：波动率模型、Greeks → [期权与波动率.md](../../../../金融知识学习/期权与波动率.md)
- **估值方法**：DCF / NPV / WACC → [估值方法.md](../../../../金融知识学习/估值方法.md)

**本文件专属**：
- **RIC（Reuters Instrument Code）**：路透金融代码，标识特定金融产品的标准代码。如 AAPL.OQ 代表苹果在纳斯达克的股票。
- **ISIN**：国际证券识别码，全球唯一的证券标识码。
- **CUSIP**：北美证券识别码，美国和加拿大证券的 9 位标识码。
- **OHLCV**：Open/High/Low/Close/Volume，技术分析的基础数据。
- **SABR 模型**：广泛使用的波动率模型，用于拟合期权波动率曲面。
