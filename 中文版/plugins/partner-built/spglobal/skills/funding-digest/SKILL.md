...
这份文件是"融资摘要（Funding Digest）"技能的详细说明。Funding Digest 是 S&P Global 等金融数据服务商提供的核心产品——它将一个复杂的公司融资/并购交易压缩成一页纸的"精华版"。

---

### 1. 什么是 Funding Digest？

**类比：**
想象你是一个风投合伙人，每天早上到公司，秘书已经帮你把昨晚到今早发生的所有融资/并购新闻整理好，压缩成"一页纸摘要"。你不用看 50 篇新闻报道，只需看 10 页摘要就能掌握全局。

Funding Digest 就是金融圈的"早间新闻摘要"——把复杂交易简化成关键信息。

---

### 2. 为什么需要 Funding Digest？

**核心痛点：**
1. **信息爆炸**——每天全球有几千笔交易
2. **时间有限**——投资人不可能看所有新闻
3. **专业门槛**——非专业人士看不懂交易条款
4. **决策支持**——需要快速判断"跟我有没有关系"

---

### 3. Funding Digest 的"标准模板"
...
| 交易规模 | 金额（美元/人民币） |
| 参与方 | 买方、卖方、投行、律所 |
| 估值 | 投前/投后估值、EV/EBITDA 倍数 |
| 资金用途 | 扩张、研发、还债、并购 |
| 行业影响 | 对行业格局的影响 |

---

### 4. 真实案例：字节跳动 2020 年融资
...
> Funding Digest 就是金融圈的"微博热搜"——把每天发生的融资、并购大事压缩成"140 字精华"。对于 PE/VC 投资人来说，Funding Digest 是"晨会必读"——5 分钟看完，就能知道"昨天市场上发生了哪些大事、跟我有什么关系"。对于金融小白来说，Funding Digest 是了解"资本市场每天在干什么"的最佳窗口。
